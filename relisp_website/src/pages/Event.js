...
export default class EventPage extends React.Component {
  ...
  componentDidMount() {
    ReactGA.pageview('/chile-19')
  }

  renderSchedule = () => {
    return (
      <div>
        <TimelineComponent data={this.state.timeline} />
      ...
      <main className='encuentro'>
        <section className='encuentro__resena'>
          <div className='container'>
            ...
            {/* { this.renderSchedule() } */}
            <div className='encuentro__sin-programa' style={{ marginTop: 80 }}>
              <p>
                <strong>ELIS</strong>, en su versión 2019, se desarrollará en la
                ciudad de Rancagua en Chile entre el 24 y 26 de Octubre.
              </p>
              <p>Pronto tendremos disponible el programa del evento.</p>
            </div>
          </div>
        </section>
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-24 col-md-20 offset-md-2'>
                <div
                  className='encuentro__formularios__wrapper'
                  id='convocatoria'
                >
                  <a
